...
4. **Sıradaki adım (tek ve net):** kullanıcı **Task 14 panel ayarlarını** yapar + manuel checklist'leri koşar → sonra **SP2 lig planı** (güçlü model), SP3a domain adaylığı. Push henüz YAPILMADI ("s" ritüeli bekliyor).
